...
const questions = [
    ...
    */
    // Question 2
    new Question(
        questionText="Who was the third president of the US?",
        correctAnswer= "Thomas Jefferson",
        answerOptions=["Thomas Jefferson", "2", "3", "4"],
        imageFilename="https://www.whitehouse.gov/wp-content/uploads/2021/01/03_thomas_jefferson.jpg"
    )
]
...
function selectAnswer(button_id) {
    ...
    selectedAnswerButton = document.getElementById(button_id) 
    selectedAnswer = selectedAnswerButton.innerText; 
